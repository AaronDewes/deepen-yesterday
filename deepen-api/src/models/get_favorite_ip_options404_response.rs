...
pub struct GetFavoriteIpOptions404Response {
    /// - [IP_IMAGE_NOT_FOUND] IPに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetFavoriteIpOptions404Response {
    pub fn new() -> GetFavoriteIpOptions404Response {
        GetFavoriteIpOptions404Response {
            error_code: None,
            error_type: None,
        }
    }
