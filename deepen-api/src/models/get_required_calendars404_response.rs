...
pub struct GetRequiredCalendars404Response {
    /// - [CALENDAR_NOT_FOUND] カレンダーが存在しない. 基本起こり得ない.マスターデータが足りない - [CALENDAR_IMAGE_NOT_FOUND] カレンダーに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetRequiredCalendars404Response {
    pub fn new() -> GetRequiredCalendars404Response {
        GetRequiredCalendars404Response {
            error_code: None,
            error_type: None,
        }
    }
