...
pub struct UpdateEventScheduleUserSettings422Response {
    /// - [EVENT_SCHEDULE_SETTING_CONFLICT] 更新する値の組み合わせが矛盾している。
...
impl UpdateEventScheduleUserSettings422Response {
    pub fn new() -> UpdateEventScheduleUserSettings422Response {
        UpdateEventScheduleUserSettings422Response {
            error_code: None,
            error_type: None,
        }
    }
