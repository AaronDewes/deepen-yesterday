...
pub struct GetContents400Response {
    /// - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです - [CONTENT_IDS_IS_REQUIRED] contentIDsが空配列の時に起こるエラーです
...
impl GetContents400Response {
    pub fn new() -> GetContents400Response {
        GetContents400Response {
            error_code: None,
            error_type: None,
        }
    }
