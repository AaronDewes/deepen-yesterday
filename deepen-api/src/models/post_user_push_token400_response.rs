...
pub struct PostUserPushToken400Response {
    /// - [INVALID_LOCALE] 誤ったLocaleが指定された - [INVALID_OS] ios/android以外のOSを指定した
...
impl PostUserPushToken400Response {
    pub fn new() -> PostUserPushToken400Response {
        PostUserPushToken400Response {
            error_code: None,
            error_type: None,
        }
    }
