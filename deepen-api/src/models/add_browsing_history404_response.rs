...
pub struct AddBrowsingHistory404Response {
    /// - [CONTENT_NOT_FOUND] コンテンツが存在しない
...
impl AddBrowsingHistory404Response {
    pub fn new() -> AddBrowsingHistory404Response {
        AddBrowsingHistory404Response {
            error_code: None,
            error_type: None,
        }
    }
