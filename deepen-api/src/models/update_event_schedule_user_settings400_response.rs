...
pub struct UpdateEventScheduleUserSettings400Response {
    /// - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです
...
impl UpdateEventScheduleUserSettings400Response {
    pub fn new() -> UpdateEventScheduleUserSettings400Response {
        UpdateEventScheduleUserSettings400Response {
            error_code: None,
            error_type: None,
        }
    }
