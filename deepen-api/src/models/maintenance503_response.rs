...
pub struct Maintenance503Response {
    ...
    #[serde(rename = "error_extra", skip_serializing_if = "Option::is_none")]
    pub error_extra: Option<Box<models::Maintenance503ResponseErrorExtra>>,
}

impl Maintenance503Response {
    pub fn new() -> Maintenance503Response {
        Maintenance503Response {
            error_code: None,
            error_type: None,
            error_extra: None,
        }
