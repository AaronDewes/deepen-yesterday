...
pub struct GetAvailableGameTitleTags400Response {
    /// - [INVALID_SORT_KEY] ソートキーが間違っています - [INVALID_SORT_OPTION] ソートのオプションが間違っています
...
impl GetAvailableGameTitleTags400Response {
    pub fn new() -> GetAvailableGameTitleTags400Response {
        GetAvailableGameTitleTags400Response {
            error_code: None,
            error_type: None,
        }
    }
