...
pub struct GetContent404Response {
    /// - [CONTENT_NOT_FOUND] コンテンツが存在しない - [CONTENT_IMAGE_NOT_FOUND] コンテンツに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetContent404Response {
    pub fn new() -> GetContent404Response {
        GetContent404Response {
            error_code: None,
            error_type: None,
        }
    }
