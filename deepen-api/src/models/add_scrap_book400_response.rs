...
pub struct AddScrapBook400Response {
    /// - [CONTENT_IS_NEWS] ニュースのコンテンツはスクラップブックに追加できない
...
impl AddScrapBook400Response {
    pub fn new() -> AddScrapBook400Response {
        AddScrapBook400Response {
            error_code: None,
            error_type: None,
        }
    }
