...
pub struct PostUserContentImpressions404Response {
    /// - [CONTENT_NOT_FOUND] Content ID が見つかりません。
...
impl PostUserContentImpressions404Response {
    pub fn new() -> PostUserContentImpressions404Response {
        PostUserContentImpressions404Response {
            error_code: None,
            error_type: None,
        }
    }
