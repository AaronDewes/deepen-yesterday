...
pub struct AuthRefresh403Response {
    /// - [VIOLATE_QUEBEC_CONSUMER_PROTECTION_ACT] カナダ ケベック州で13歳未満のユーザは登録できません
...
impl AuthRefresh403Response {
    pub fn new() -> AuthRefresh403Response {
        AuthRefresh403Response {
            error_code: None,
            error_type: None,
        }
    }
