...
pub struct AuthRefresh400Response {
    /// - [RELOGIN_REQUIRED] 認証に失敗したので再ログインが必要 - [USER_NOT_FOUND] ユーザが存在しませんでした
...
impl AuthRefresh400Response {
    pub fn new() -> AuthRefresh400Response {
