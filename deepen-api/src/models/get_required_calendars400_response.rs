...
pub struct GetRequiredCalendars400Response {
    /// - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです - [INVALID_SKIN_IP] 間違ったSkinIp
...
impl GetRequiredCalendars400Response {
    pub fn new() -> GetRequiredCalendars400Response {
        GetRequiredCalendars400Response {
            error_code: None,
            error_type: None,
        }
    }
