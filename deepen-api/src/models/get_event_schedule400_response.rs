...
pub struct GetEventSchedule400Response {
    /// - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです - [INVALID_NOTIFY_SECONDS] notify_before_secondsが負の数、もしくは1年を超える場合に返すエラーです
...
impl GetEventSchedule400Response {
    pub fn new() -> GetEventSchedule400Response {
        GetEventSchedule400Response {
            error_code: None,
            error_type: None,
        }
    }
