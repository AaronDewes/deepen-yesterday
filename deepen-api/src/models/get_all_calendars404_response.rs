...
pub struct GetAllCalendars404Response {
    /// - [CALENDAR_IMAGE_NOT_FOUND] カレンダーに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetAllCalendars404Response {
    pub fn new() -> GetAllCalendars404Response {
        GetAllCalendars404Response {
            error_code: None,
            error_type: None,
        }
    }
