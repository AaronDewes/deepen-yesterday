...
pub struct PreconditionFailed412Response {
    /// - [NOT_ACCEPTABLE_APPLICATION_VERSION] 最低動作バージョンを満たしていない。
...
impl PreconditionFailed412Response {
    pub fn new() -> PreconditionFailed412Response {
        PreconditionFailed412Response {
            error_code: None,
            error_type: None,
        }
    }
