...
pub struct GetSettingCalendar404Response {
    /// - [GAME_TITLE_IMAGE_NOT_FOUND] GameTitleに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetSettingCalendar404Response {
    pub fn new() -> GetSettingCalendar404Response {
        GetSettingCalendar404Response {
            error_code: None,
            error_type: None,
        }
    }
