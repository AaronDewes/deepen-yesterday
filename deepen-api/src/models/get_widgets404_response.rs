...
pub struct GetWidgets404Response {
    /// - [WIDGET_NOT_FOUND] Widgetが存在しない. 基本起こり得ない.マスターデータが足りない - [WIDGET_IMAGE_NOT_FOUND] Widgetに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetWidgets404Response {
    pub fn new() -> GetWidgets404Response {
        GetWidgets404Response {
            error_code: None,
            error_type: None,
        }
    }
