...
pub struct SearchContents404Response {
    /// - [TAG_NOT_FOUND] 指定したTAGが存在しないエラーです - [CONTENT_IMAGE_NOT_FOUND] コンテンツに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl SearchContents404Response {
    pub fn new() -> SearchContents404Response {
        SearchContents404Response {
            error_code: None,
            error_type: None,
        }
    }
