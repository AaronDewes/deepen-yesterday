...
pub struct GetAvailableGameTitleTags404Response {
    /// - [CONTENT_TAG_IMAGE_NOT_FOUND] タグに紐づく画像が存在しない. 基本起こり得ない. マスターデータが足りない
...
impl GetAvailableGameTitleTags404Response {
    pub fn new() -> GetAvailableGameTitleTags404Response {
        GetAvailableGameTitleTags404Response {
            error_code: None,
            error_type: None,
        }
    }
