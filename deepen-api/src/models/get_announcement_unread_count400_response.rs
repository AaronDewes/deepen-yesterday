...
pub struct GetAnnouncementUnreadCount400Response {
    /// - [INVALID_OS] ios/android以外のOSを指定した
...
impl GetAnnouncementUnreadCount400Response {
    pub fn new() -> GetAnnouncementUnreadCount400Response {
        GetAnnouncementUnreadCount400Response {
            error_code: None,
            error_type: None,
        }
    }
