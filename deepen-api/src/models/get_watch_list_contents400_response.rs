...
pub struct GetWatchListContents400Response {
    /// - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです - [INVALID_NUM] numが0以下もしくは上限を超えているエラーです - [INVALID_SORT_OPTION] 0, 1以外を指定した時に起こるエラーです - [INVALID_SORT_KEY] 間違ったsort_keyを指定した時に起こるエラーです
...
impl GetWatchListContents400Response {
    pub fn new() -> GetWatchListContents400Response {
        GetWatchListContents400Response {
            error_code: None,
            error_type: None,
        }
    }
