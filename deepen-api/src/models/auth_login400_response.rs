...
pub struct AuthLogin400Response {
    /// - [INVALID_BAAS_TOKEN] BaaS UserのID Tokenの検証に失敗しました - [INVALID_NA_TOKEN] NAのID Tokenの検証に失敗しました - [INVALID_BAAS_USER] BaaS UserもしくはNAとの連携が確認できませんでした
...
impl AuthLogin400Response {
    pub fn new() -> AuthLogin400Response {
