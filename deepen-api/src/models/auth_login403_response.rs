...
pub struct AuthLogin403Response {
    /// - [VIOLATE_QUEBEC_CONSUMER_PROTECTION_ACT] ケベック州消費者保護法に違反する(カナダ ケベック州在住で13歳未満)
...
impl AuthLogin403Response {
    pub fn new() -> AuthLogin403Response {
