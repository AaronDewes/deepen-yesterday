...
pub struct SearchContents400Response {
    /// - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです - [INVALID_NUM] numが0以下もしくは上限を超えているエラーです - [INVALID_SORT_OPTION] 0, 1以外を指定した時に起こるエラーです - [TAG_IDS_IS_REQUIRED] tagIDsが空配列の時に起こるエラーです
...
impl SearchContents400Response {
    pub fn new() -> SearchContents400Response {
        SearchContents400Response {
            error_code: None,
            error_type: None,
        }
    }
