...
pub struct GetEventSchedules400Response {
    /// - [INVALID_START_DATE] start_dateの形式が間違っている - [INVALID_END_DATE] end_dateの形式が間違っている - [INVALID_TIME_ZONE] タイムゾーンの解決に失敗したエラーです
...
impl GetEventSchedules400Response {
    pub fn new() -> GetEventSchedules400Response {
        GetEventSchedules400Response {
            error_code: None,
            error_type: None,
        }
    }
